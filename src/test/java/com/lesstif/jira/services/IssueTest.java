...
public class IssueTest {
    ...
    public static void beforeClass() {
        ...
        PROJECT_KEY = System.getProperty("jira.test.project", "MGM");
        ISSUE_KEY = System.getProperty("jira.test.issue", "MGM-7");
        ASSIGNEE = System.getProperty("jira.test.assignee", "sweethareddy.baikadi");
        REPORTER = System.getProperty("jira.test.reporter", "sweethareddy.baikadi@cognizant.com");
    }
 ...
 /*  @Test
    public void cUploadAttachments() throws IOException, ConfigurationException {
       ...
       // issue.addAttachment(new File("attachment.png"));
        issue.addAttachment("docker-compose.override.pdf");
